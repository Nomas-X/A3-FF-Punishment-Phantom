...
Parameters:
    ...
    [<STRING>,<SCALER>] Icon Path & Aspect Ratio. [DEFAULT=["z\ffpp\addons\main\functions\ui\UI\images\logo.paa",4] (512/128=4)]
...
Examples:
    ...
    ["Vaya...", "Parece que sus notificaciones importantes se cifraron.<br/><br/>Nadie espera el cifrado español.", false, ["z\ffpp\addons\main\functions\ui\images\A3Logo.paa",1]] remoteExec ["FFPP_fnc_customHint", 0, false];

    // Pre-parse FooBar(Hello World) NoMacro
        private _iconXML = parseText "<img color='#ffffff' image='z\ffpp\addons\main\functions\ui\images\logo.paa' align='center' size='2' shadow='1' shadowColor='#000000' />";
        private _separator  = parseText "<br/><img color='#e6b24a' image='z\ffpp\addons\main\functions\ui\images\img_line_ca.paa' align='center' size='0.60' />";
...
params [
    ...
    ["_iconData", ["z\ffpp\addons\main\functions\ui\images\A3Logo.paa",2], [ [] ], 2]
];
...
if (_bodyText isEqualType parseText "") then {
    ...
    _structuredText = parseText ([
        ...
        _headerText,
        "</t><br/><img size='0.60' color='#218a36' image='z\ffpp\addons\main\functions\ui\images\img_line_ca.paa' /><br/><br/><t >",
        _bodyText,
        "</t><br/><br/><img size='0.60' color='#218a36' image='z\ffpp\addons\main\functions\ui\images\img_line_ca.paa' /></t>"
    ] joinString "");
};
